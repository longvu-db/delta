...
public  class DefaultRowCommitVersionSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.execution.datasources.parquet.ParquetTest, org.apache.spark.sql.delta.rowid.RowIdTestUtils {
  public   DefaultRowCommitVersionSuite ()  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Map<java.lang.String, java.lang.Object> expectedCommitVersionsForAllFiles (org.apache.spark.sql.delta.DeltaLog deltaLog)  { throw new RuntimeException(); }
