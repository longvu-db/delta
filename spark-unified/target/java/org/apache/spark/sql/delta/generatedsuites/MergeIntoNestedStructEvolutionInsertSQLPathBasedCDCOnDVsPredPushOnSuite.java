...
public  class MergeIntoNestedStructEvolutionInsertSQLPathBasedCDCOnDVsPredPushOnSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.MergeIntoNestedStructEvolutionInsertTests, org.apache.spark.sql.delta.MergeIntoSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsPathBased, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.MergeIntoDVsMixin, org.apache.spark.sql.delta.PredicatePushdownEnabled, org.apache.spark.sql.delta.cdc.MergeCDCMixin, org.apache.spark.sql.delta.MergeCDCWithDVsMixin {
  ...
  public   MergeIntoNestedStructEvolutionInsertSQLPathBasedCDCOnDVsPredPushOnSuite ()  { throw new RuntimeException(); }
