...
public  class CloneTableSQLSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.CloneTableSuiteBase, org.apache.spark.sql.delta.CloneTableSQLTestMixin, org.apache.spark.sql.delta.DeltaColumnMappingTestUtils, org.apache.spark.sql.delta.coordinatedcommits.CatalogOwnedTestBaseSuite {
  public   CloneTableSQLSuite ()  { throw new RuntimeException(); }
  ...
  protected  org.scalatest.Tag TAG_CHANGE_COLUMN_MAPPING_MODE ()  { throw new RuntimeException(); }
  protected  org.scalatest.Tag TAG_HAS_SHALLOW_CLONE ()  { throw new RuntimeException(); }
  protected  org.scalatest.Tag TAG_MODIFY_PROTOCOL ()  { throw new RuntimeException(); }
  protected  org.scalatest.Tag TAG_USES_CONVERT_TO_DELTA ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.CloneTableSuiteBase.TableFeatureWithProperty$ TableFeatureWithProperty ()  { throw new RuntimeException(); }
  ...
  public final  scala.collection.immutable.Seq<org.apache.spark.sql.delta.CloneTableSuiteBase.TableFeatureWithProperty> featuresWithAutomaticProtocolUpgrade ()  { throw new RuntimeException(); }
