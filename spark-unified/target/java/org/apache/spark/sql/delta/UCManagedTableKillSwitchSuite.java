 ...
 * by overriding {@link OptimisticTransaction.isUCManagedTable} in a test-local subclass.
 * <p>
 * The kill switch fires in {@link OptimisticTransaction.commitLarge}, which is used by RESTORE TABLE
 * and bypasses prepareCommit.
 */
public  class UCManagedTableKillSwitchSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.delta.coordinatedcommits.CatalogOwnedTestBaseSuite, org.apache.spark.sql.delta.test.DeltaSQLTestUtils, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  ...
  public   UCManagedTableKillSwitchSuite ()  { throw new RuntimeException(); }
  ...
  public  scala.Option<java.lang.Object> catalogOwnedCoordinatorBackfillBatchSize ()  { throw new RuntimeException(); }
