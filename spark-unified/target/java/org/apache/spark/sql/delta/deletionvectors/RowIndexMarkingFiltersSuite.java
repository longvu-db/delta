...
public  class RowIndexMarkingFiltersSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession {
  public  org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig$ PatienceConfig ()  { throw new RuntimeException(); }
  public   RowIndexMarkingFiltersSuite ()  { throw new RuntimeException(); }
   ...
   * a {@link DeletionVectorDescriptor}. DV created can be an in-line or on disk
   * @param isInline (undocumented)
   * @param tablePath (undocumented)
   * @param markedRows (undocumented)
   * @return (undocumented)
   */
  protected  org.apache.spark.sql.delta.actions.DeletionVectorDescriptor createDV (boolean isInline, org.apache.hadoop.fs.Path tablePath, scala.collection.immutable.Seq<java.lang.Object> markedRows)  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Seq<java.lang.Object> getMarked (org.apache.spark.sql.delta.RowIndexFilter rowIndexFilter, long start, long end)  { throw new RuntimeException(); }
  ...
  protected  org.apache.hadoop.conf.Configuration newHadoopConf ()  { throw new RuntimeException(); }
