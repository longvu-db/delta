...
public  class CheckpointsSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.DeltaCheckpointTestUtils, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.test.DeltaSQLTestUtils, org.apache.spark.sql.delta.coordinatedcommits.CatalogOwnedTestBaseSuite {
  public   CheckpointsSuite ()  { throw new RuntimeException(); }
  ...
  public  void checkIntermittentError (java.io.File tempDir, boolean lastCheckpointMissing, boolean crcMissing)  { throw new RuntimeException(); }
  ...
  /** Get V2 {@link CheckpointProvider} from the underlying deltalog snapshot */
  public  org.apache.spark.sql.delta.V2CheckpointProvider getV2CheckpointProvider (org.apache.spark.sql.delta.DeltaLog deltaLog, boolean update)  { throw new RuntimeException(); }
  ...
  public  void testDifferentV2Checkpoints (java.lang.String testName, scala.Function0<scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
