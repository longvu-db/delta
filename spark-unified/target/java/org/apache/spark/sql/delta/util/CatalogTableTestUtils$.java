...
public  class CatalogTableTestUtils$ {
   ...
   */
  public static final CatalogTableTestUtils$ MODULE$ = null;
  public   CatalogTableTestUtils$ ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.catalog.CatalogTable createCatalogTable (java.lang.String tableName, scala.Option<java.lang.String> catalogName, java.util.Map<java.lang.String, java.lang.String> properties, java.util.Map<java.lang.String, java.lang.String> storageProperties, scala.Option<java.net.URI> locationUri, boolean nullStorage, boolean nullStorageProperties)  { throw new RuntimeException(); }
}
