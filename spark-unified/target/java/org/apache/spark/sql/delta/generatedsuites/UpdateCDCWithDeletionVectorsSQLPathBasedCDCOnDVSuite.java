...
public  class UpdateCDCWithDeletionVectorsSQLPathBasedCDCOnDVSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.cdc.UpdateCDCWithDeletionVectorsTests, org.apache.spark.sql.delta.UpdateSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsPathBased, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.UpdateSQLWithDeletionVectorsMixin {
  ...
  public   UpdateCDCWithDeletionVectorsSQLPathBasedCDCOnDVSuite ()  { throw new RuntimeException(); }
