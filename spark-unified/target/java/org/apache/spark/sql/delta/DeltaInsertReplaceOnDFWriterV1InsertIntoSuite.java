 ...
 * Reuses shared tests from {@link DeltaInsertReplaceOnDFWriterTests} using
 * delta.<code>/path</code> syntax for insertInto, and adds insertInto-specific tests.
 */
public  class DeltaInsertReplaceOnDFWriterV1InsertIntoSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.DeltaInsertReplaceOnDFWriterTests {
  public  org.apache.spark.sql.delta.DeltaInsertReplaceOnOrUsingTestUtils.DataLayoutType$ DataLayoutType ()  { throw new RuntimeException(); }
  public   DeltaInsertReplaceOnDFWriterV1InsertIntoSuite ()  { throw new RuntimeException(); }
  ...
  protected  void writeReplaceOnDF (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> sourceDF, java.lang.String target, java.lang.String replaceOnCond, scala.Option<java.lang.String> targetAlias, boolean mergeSchema)  { throw new RuntimeException(); }
}
