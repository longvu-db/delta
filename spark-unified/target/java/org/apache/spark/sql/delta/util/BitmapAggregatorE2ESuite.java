...
public  class BitmapAggregatorE2ESuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.test.DeltaSQLTestUtils {
  static public final  long DATASET_SIZE ()  { throw new RuntimeException(); }
  static public final  long INVALID_INT_OFFSET ()  { throw new RuntimeException(); }
  static public final  long UNSIGNED_INT_OFFSET ()  { throw new RuntimeException(); }
  static   org.apache.spark.sql.Column bitmapAggColumn (org.apache.spark.sql.Column column, scala.Enumeration.Value format)  { throw new RuntimeException(); }
  ...
  public   BitmapAggregatorE2ESuite ()  { throw new RuntimeException(); }
  public  void dataFrameBitmapGroupAggregateWithDuplicates (long offset, scala.Enumeration.Value format)  { throw new RuntimeException(); }
}
