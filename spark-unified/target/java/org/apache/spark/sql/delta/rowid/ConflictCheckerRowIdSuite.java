...
public  class ConflictCheckerRowIdSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.concurrency.PhaseLockingTestMixin, org.apache.spark.sql.delta.concurrency.TransactionExecutionTestMixin, org.apache.spark.sql.delta.rowid.RowIdTestUtils {
  public   ConflictCheckerRowIdSuite ()  { throw new RuntimeException(); }
  ...
  protected  void appendRows (java.io.File dir, int numRows, int numFiles)  { throw new RuntimeException(); }
  ...
  protected  void setIsolationLevel (java.io.File tableDir)  { throw new RuntimeException(); }
