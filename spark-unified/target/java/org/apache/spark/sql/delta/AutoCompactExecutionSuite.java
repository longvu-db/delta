...
/**
 * This class extends the {@link CompactionSuiteBase} and runs all the {@link CompactionSuiteBase} tests
 * with AutoCompaction.
 * <p>
 * It also tests AutoCompaction specific behavior around compaction execution.
 */
public  class AutoCompactExecutionSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.optimize.CompactionTestHelperForAutoCompaction, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.AutoCompactTestUtils {
  public   AutoCompactExecutionSuite ()  { throw new RuntimeException(); }
  ...
  public  java.lang.String maxFileSizeConf ()  { throw new RuntimeException(); }
  public  java.lang.String minFileSizeConf ()  { throw new RuntimeException(); }
