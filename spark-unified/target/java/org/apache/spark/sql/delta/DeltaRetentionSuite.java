...
public  class DeltaRetentionSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.DeltaRetentionSuiteBase, org.apache.spark.sql.delta.test.DeltaSQLTestUtils, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.CheckpointProtectionTestUtilsMixin {
  public   DeltaRetentionSuite ()  { throw new RuntimeException(); }
  ...
  protected  void cleanUpExpiredLogs (org.apache.spark.sql.delta.DeltaLog log)  { throw new RuntimeException(); }
  ...
  public  long removeFileCountFromUnderlyingCheckpoint (org.apache.spark.sql.delta.Snapshot snapshot)  { throw new RuntimeException(); }
