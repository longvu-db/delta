...
public  class MergeIntoNotMatchedBySourceCDCPart1SQLPathBasedCDCOnDVsPredPushOnSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.MergeIntoNotMatchedBySourceCDCPart1Tests, org.apache.spark.sql.delta.MergeIntoSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsPathBased, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.MergeIntoDVsMixin, org.apache.spark.sql.delta.PredicatePushdownEnabled, org.apache.spark.sql.delta.cdc.MergeCDCMixin, org.apache.spark.sql.delta.MergeCDCWithDVsMixin {
  ...
  public   MergeIntoNotMatchedBySourceCDCPart1SQLPathBasedCDCOnDVsPredPushOnSuite ()  { throw new RuntimeException(); }
