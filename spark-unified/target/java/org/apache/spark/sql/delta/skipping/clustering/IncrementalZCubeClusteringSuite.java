...
public  class IncrementalZCubeClusteringSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.skipping.ClusteredTableTestUtilsBase, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  public  org.apache.spark.sql.delta.DeltaTestUtilsBase.ExpectedResult$ ExpectedResult ()  { throw new RuntimeException(); }
  public   IncrementalZCubeClusteringSuite ()  { throw new RuntimeException(); }
