...
public  class CatalogOwnedEnablementSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.coordinatedcommits.CatalogOwnedTestBaseSuite, org.apache.spark.sql.delta.test.DeltaSQLTestUtils, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.DeltaTestUtilsBase, org.apache.spark.sql.delta.test.DeltaExceptionTestUtils {
  public   CatalogOwnedEnablementSuite ()  { throw new RuntimeException(); }
  ...
  protected  java.lang.String commitCoordinatorName ()  { throw new RuntimeException(); }
  ...
  protected  void createTable (java.lang.String tableName, scala.collection.immutable.Seq<java.lang.String> clusterBy, scala.collection.immutable.Map<java.lang.String, java.lang.String> properties)  { throw new RuntimeException(); }
