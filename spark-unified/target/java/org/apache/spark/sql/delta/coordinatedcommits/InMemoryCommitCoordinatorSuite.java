...
public abstract class InMemoryCommitCoordinatorSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.coordinatedcommits.CommitCoordinatorClientImplSuiteBase {
  public  org.apache.spark.sql.delta.DeltaTestUtilsBase.ExpectedResult$ ExpectedResult ()  { throw new RuntimeException(); }
  public   InMemoryCommitCoordinatorSuite (int batchSize)  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.delta.coordinatedcommits.TableCommitCoordinatorClient createTableCommitCoordinatorClient (org.apache.spark.sql.delta.DeltaLog deltaLog)  { throw new RuntimeException(); }
  ...
  protected  void registerBackfillOp (org.apache.spark.sql.delta.coordinatedcommits.TableCommitCoordinatorClient tableCommitCoordinatorClient, org.apache.spark.sql.delta.DeltaLog deltaLog, long version)  { throw new RuntimeException(); }
  ...
  protected  void validateBackfillStrategy (org.apache.spark.sql.delta.coordinatedcommits.TableCommitCoordinatorClient tableCommitCoordinatorClient, org.apache.hadoop.fs.Path logPath, long version)  { throw new RuntimeException(); }
  protected  void validateGetCommitsResult (io.delta.storage.commit.GetCommitsResponse result, scala.Option<java.lang.Object> startVersion, scala.Option<java.lang.Object> endVersion, long maxVersion)  { throw new RuntimeException(); }
