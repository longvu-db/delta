...
public  class DescribeDeltaHistorySuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.DescribeDeltaHistorySuiteBase, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  public   DescribeDeltaHistorySuite ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Seq<java.lang.String> evolvabilityLastOp ()  { throw new RuntimeException(); }
  protected  java.lang.String evolvabilityResource ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<java.lang.String> expectedInsertOperationParameters ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Set<java.lang.String> mergeMetricsSchema ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Set<java.lang.String> replaceWhereMetricsSchema ()  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<java.lang.String> testsToIgnore ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Set<java.lang.String> updateMetricsSchema ()  { throw new RuntimeException(); }
