...
public  class RowTrackingConflictResolutionSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.DeletionVectorsTestUtils, org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.rowid.RowIdTestUtils {
  ...
  public   RowTrackingConflictResolutionSuite ()  { throw new RuntimeException(); }
  ...
  public  void assertBaseRowIDsAndDefaultRowCommitVersionsAssigned (scala.collection.immutable.Seq<org.apache.spark.sql.delta.actions.AddFile> finalFiles)  { throw new RuntimeException(); }
