...
public abstract class DeltaSinkTest extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  ...
  public   DeltaSinkTest ()  { throw new RuntimeException(); }
  ...
  protected  void withTempDirs (scala.Function2<java.io.File, java.io.File, scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
}
