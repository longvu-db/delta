...
public abstract class LogStoreSuiteBase extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.storage.LogStoreProvider, org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  public   LogStoreSuiteBase ()  { throw new RuntimeException(); }
  ...
  public abstract  java.lang.String logStoreClassName ()  ;
  ...
  public  org.apache.hadoop.conf.Configuration sessionHadoopConf ()  { throw new RuntimeException(); }
  /**
   * Whether the log store being tested should use rename to write checkpoint or not. The following
   * test is using this method to verify the behavior of <code>checkpoint</code>.
   * @return (undocumented)
   */
  protected abstract  boolean shouldUseRenameToWriteCheckpoint ()  ;
  ...
  protected  void testHadoopConf (java.lang.String expectedErrMsg, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> fsImplConfs)  { throw new RuntimeException(); }
  ...
  protected  void withTempLogDir (scala.Function1<java.io.File, scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
}
