...
public  class DeltaSourceSchemaEvolutionCDCNameColumnMappingSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.CDCStreamingSchemaEvolutionSuiteBase, org.apache.spark.sql.delta.DeltaColumnMappingEnableNameMode {
  ...
  protected  org.apache.spark.sql.streaming.StreamTest.AssertOnQuery AwaitTermination ()  { throw new RuntimeException(); }
  protected  org.apache.spark.sql.streaming.StreamTest.AssertOnQuery AwaitTerminationIgnoreError ()  { throw new RuntimeException(); }
  ...
  public   DeltaSourceSchemaEvolutionCDCNameColumnMappingSuite ()  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.streaming.StreamTest.ExpectFailure<org.apache.spark.sql.delta.DeltaRuntimeException> ExpectMetadataEvolutionExceptionFromInitialization ()  { throw new RuntimeException(); }
  protected  org.apache.spark.sql.streaming.StreamTest.ExpectFailure<org.apache.spark.sql.delta.DeltaRuntimeException> ExpectSchemaLogInitializationFailedException ()  { throw new RuntimeException(); }
  ...
  protected  long indexWhenSchemaLogIsUpdated ()  { throw new RuntimeException(); }
  protected  org.apache.spark.sql.classic.Dataset<org.apache.spark.sql.Row> intervalData ()  { throw new RuntimeException(); }
  public  boolean isCdcTest ()  { throw new RuntimeException(); }
