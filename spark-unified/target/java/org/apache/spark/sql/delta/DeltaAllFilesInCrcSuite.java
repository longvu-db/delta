...
public  class DeltaAllFilesInCrcSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.concurrency.TransactionExecutionTestMixin, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.concurrency.PhaseLockingTestMixin {
  public   DeltaAllFilesInCrcSuite ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Seq<com.databricks.spark.util.UsageRecord> filterUsageRecords (scala.collection.immutable.Seq<com.databricks.spark.util.UsageRecord> usageRecords, java.lang.String opType)  { throw new RuntimeException(); }
