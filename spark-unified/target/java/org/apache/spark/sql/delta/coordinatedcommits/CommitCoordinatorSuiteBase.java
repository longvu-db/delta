...
public abstract class CommitCoordinatorSuiteBase extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.coordinatedcommits.CommitCoordinatorUtilBase, org.apache.spark.sql.delta.test.DeltaSQLTestUtils, org.apache.spark.sql.delta.DeltaTestUtilsBase, org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.test.DeltaExceptionTestUtils {
  public   CommitCoordinatorSuiteBase ()  { throw new RuntimeException(); }
  ...
  public  void runGetChangeLogFiles (org.apache.spark.sql.delta.DeltaLog deltaLog, long startVersion, scala.Option<java.lang.Object> endVersionOpt, long totalCommitsOnTable, long expectedLastBackfilledCommit, boolean updateExpected)  { throw new RuntimeException(); }
