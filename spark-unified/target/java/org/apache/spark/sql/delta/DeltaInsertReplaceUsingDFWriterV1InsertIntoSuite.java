 ...
 * Reuses shared tests from {@link DeltaInsertReplaceUsingDFWriterTests} using
 * delta.<code>/path</code> syntax for insertInto, and adds insertInto-specific tests.
 */
public  class DeltaInsertReplaceUsingDFWriterV1InsertIntoSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.DeltaInsertReplaceUsingDFWriterTests {
  public   DeltaInsertReplaceUsingDFWriterV1InsertIntoSuite ()  { throw new RuntimeException(); }
  ...
  protected  void writeReplaceUsingDF (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> sourceDF, java.lang.String target, java.lang.String replaceUsingCols, java.lang.String writeMode, boolean mergeSchema, scala.collection.immutable.Map<java.lang.String, java.lang.String> options)  { throw new RuntimeException(); }
}
