...
public  class TableRedirectSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.coordinatedcommits.CoordinatedCommitsBaseSuite, org.apache.spark.sql.delta.DeltaCheckpointTestUtils, org.apache.spark.sql.delta.test.DeltaSQLTestUtils {
  ...
  public   TableRedirectSuite ()  { throw new RuntimeException(); }
  ...
  public  void redirectTest (java.lang.String label, boolean enableRedirect, scala.Function4<org.apache.spark.sql.delta.DeltaLog, java.io.File, java.io.File, org.apache.spark.sql.catalyst.catalog.CatalogTable, scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
