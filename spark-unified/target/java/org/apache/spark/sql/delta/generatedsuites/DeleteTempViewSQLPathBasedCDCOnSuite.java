...
public  class DeleteTempViewSQLPathBasedCDCOnSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.DeleteTempViewTests, org.apache.spark.sql.delta.DeleteSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsPathBased, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.cdc.DeleteCDCMixin {
  public   DeleteTempViewSQLPathBasedCDCOnSuite ()  { throw new RuntimeException(); }
