...
public  class DeltaSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.DeltaColumnMappingTestUtils, org.apache.spark.sql.delta.test.DeltaSQLTestUtils, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.coordinatedcommits.CatalogOwnedTestBaseSuite {
  public   DeltaSuite ()  { throw new RuntimeException(); }
  ...
  public  void idempotentWrite (java.lang.String mode, java.lang.String appId, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> seq, java.lang.String path, java.lang.String name, long version, long expectedCount, int commitVersion, boolean isSaveAsTable)  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.delta.DeltaHistory lastDeltaHistory (java.lang.String dir)  { throw new RuntimeException(); }
  ...
  public  void testReplaceWhereWithCdf (boolean replaceWhereInDataColumn)  { throw new RuntimeException(); }
