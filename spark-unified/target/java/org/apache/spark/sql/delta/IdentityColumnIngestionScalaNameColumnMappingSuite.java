...
public  class IdentityColumnIngestionScalaNameColumnMappingSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.IdentityColumnIngestionSuiteBase, org.apache.spark.sql.delta.ScalaDDLTestUtils, org.apache.spark.sql.delta.DeltaColumnMappingEnableNameMode {
  public  org.apache.spark.sql.delta.DDLTestUtils.DDLType$ DDLType ()  { throw new RuntimeException(); }
  public   IdentityColumnIngestionScalaNameColumnMappingSuite ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.IdentityColumnIngestionSuiteBase.IngestMode$ IngestMode ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.IdentityColumnIngestionSuiteBase.IngestTestCase$ IngestTestCase ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Seq<org.apache.spark.sql.types.DataType> unsupportedDataTypes ()  { throw new RuntimeException(); }
