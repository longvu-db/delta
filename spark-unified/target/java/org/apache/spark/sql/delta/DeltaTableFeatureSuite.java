...
public  class DeltaTableFeatureSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  public   DeltaTableFeatureSuite ()  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.delta.DeltaLog createTableWithProtocol (org.apache.spark.sql.delta.actions.Protocol protocol, java.io.File path, org.apache.spark.sql.types.StructType schema)  { throw new RuntimeException(); }
