...
public  class OptimizeConflictSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.concurrency.PhaseLockingTestMixin, org.apache.spark.sql.delta.concurrency.TransactionExecutionTestMixin, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  public   OptimizeConflictSuite ()  { throw new RuntimeException(); }
