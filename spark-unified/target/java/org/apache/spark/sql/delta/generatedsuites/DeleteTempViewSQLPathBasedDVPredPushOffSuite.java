...
public  class DeleteTempViewSQLPathBasedDVPredPushOffSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.DeleteTempViewTests, org.apache.spark.sql.delta.DeleteSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsPathBased, org.apache.spark.sql.delta.DeleteSQLWithDeletionVectorsMixin, org.apache.spark.sql.delta.PredicatePushdownDisabled {
  public   DeleteTempViewSQLPathBasedDVPredPushOffSuite ()  { throw new RuntimeException(); }
