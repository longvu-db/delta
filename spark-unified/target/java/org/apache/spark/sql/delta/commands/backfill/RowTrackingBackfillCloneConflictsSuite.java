 ...
 */
public  class RowTrackingBackfillCloneConflictsSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.commands.backfill.RowTrackingBackfillConflictsTestBase {
  public  org.apache.spark.sql.delta.commands.backfill.RowTrackingBackfillConflictsTestBase.BackgroundErrorSink$ BackgroundErrorSink ()  { throw new RuntimeException(); }
  public  org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig$ PatienceConfig ()  { throw new RuntimeException(); }
  public  java.lang.String QUALIFIED_BASE_ROW_ID_COLUMN_NAME ()  { throw new RuntimeException(); }
  public   RowTrackingBackfillCloneConflictsSuite ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.commands.backfill.RowTrackingBackfillConflictsTestBase.TrackingBackfillExecutionObserver$ TrackingBackfillExecutionObserver ()  { throw new RuntimeException(); }
  ...
  protected  java.util.concurrent.ConcurrentLinkedDeque<org.apache.spark.sql.delta.fuzzer.PhaseLockingTransactionExecutionObserver> backfillObservers ()  { throw new RuntimeException(); }
  ...
  protected  java.lang.String colName ()  { throw new RuntimeException(); }
  ...
  protected  int numPartitions ()  { throw new RuntimeException(); }
  protected  int numRows ()  { throw new RuntimeException(); }
  protected  java.lang.String partitionColumnName ()  { throw new RuntimeException(); }
  ...
  public  java.lang.String sourceTableName ()  { throw new RuntimeException(); }
  ...
  protected  boolean usePersistentDeletionVectors ()  { throw new RuntimeException(); }
