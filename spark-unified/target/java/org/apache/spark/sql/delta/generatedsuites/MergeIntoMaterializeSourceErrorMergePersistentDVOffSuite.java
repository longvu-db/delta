...
public  class MergeIntoMaterializeSourceErrorMergePersistentDVOffSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.MergeIntoMaterializeSourceErrorTests, org.apache.spark.sql.delta.MergePersistentDVDisabled {
  public  org.apache.spark.sql.delta.DeltaTestUtilsBase.ExpectedResult$ ExpectedResult ()  { throw new RuntimeException(); }
  public   MergeIntoMaterializeSourceErrorMergePersistentDVOffSuite ()  { throw new RuntimeException(); }
