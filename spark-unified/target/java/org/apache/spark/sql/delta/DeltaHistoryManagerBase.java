...
public abstract class DeltaHistoryManagerBase extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.DeltaTimeTravelTests {
  public   DeltaHistoryManagerBase ()  { throw new RuntimeException(); }
  ...
  protected  java.text.SimpleDateFormat timeFormatter ()  { throw new RuntimeException(); }
