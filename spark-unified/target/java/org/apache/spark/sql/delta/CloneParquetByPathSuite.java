...
public  class CloneParquetByPathSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.CloneParquetSuiteBase, org.apache.spark.sql.delta.test.DeltaExceptionTestUtils {
  public   CloneParquetByPathSuite ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.CloneParquetSuiteBase.ParquetIdent$ ParquetIdent ()  { throw new RuntimeException(); }
  ...
  protected  void withParquetTable (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> df, scala.collection.immutable.Seq<java.lang.String> partCols, scala.Function1<org.apache.spark.sql.delta.CloneParquetSuiteBase.ParquetIdent, scala.runtime.BoxedUnit> func)  { throw new RuntimeException(); }
}
