...
public  class MergeIntoNestedDataSQLPathBasedCDCOnDVsPredPushOffSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.MergeIntoNestedDataTests, org.apache.spark.sql.delta.MergeIntoSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsPathBased, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.MergeIntoDVsMixin, org.apache.spark.sql.delta.PredicatePushdownDisabled, org.apache.spark.sql.delta.cdc.MergeCDCMixin, org.apache.spark.sql.delta.MergeCDCWithDVsMixin {
  ...
  public   MergeIntoNestedDataSQLPathBasedCDCOnDVsPredPushOffSuite ()  { throw new RuntimeException(); }
