...
public  class RowTrackingMergeCommonNameBasedColMapNameModeCDCOnRowTrackingMergeDVSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.rowid.RowTrackingMergeCommonTests, org.apache.spark.sql.delta.DeltaDMLTestUtilsNameBased, org.apache.spark.sql.delta.DeltaColumnMappingEnableNameMode, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.rowid.RowTrackingMergeDVMixin {
  ...
  public   RowTrackingMergeCommonNameBasedColMapNameModeCDCOnRowTrackingMergeDVSuite ()  { throw new RuntimeException(); }
  protected  java.lang.String SOURCE_TABLE_NAME ()  { throw new RuntimeException(); }
  ...
  protected  int numUnmatchedRows ()  { throw new RuntimeException(); }
