...
public  class UpdateBaseTempViewSQLPathBasedCDCOnRowTrackingOnSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.UpdateBaseTempViewTests, org.apache.spark.sql.delta.UpdateSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsPathBased, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.rowtracking.RowTrackingEnabled, org.apache.spark.sql.delta.rowid.UpdateWithRowTrackingOverrides {
  ...
  public   UpdateBaseTempViewSQLPathBasedCDCOnRowTrackingOnSuite ()  { throw new RuntimeException(); }
