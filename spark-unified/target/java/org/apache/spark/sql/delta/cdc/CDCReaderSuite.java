...
public  class CDCReaderSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.CheckCDCAnswer, org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.DeltaColumnMappingTestUtils {
  public   CDCReaderSuite ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> createCDFDF (long start, long end, long commitVersion, java.lang.String changeType)  { throw new RuntimeException(); }
