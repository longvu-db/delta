...
public  class RowTrackingUpdateCommonRowTrackingUpdateDVCDCOnColMapIdModeSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.rowid.RowTrackingUpdateCommonTests, org.apache.spark.sql.delta.rowid.RowTrackingUpdateDVMixin, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.DeltaColumnMappingEnableIdMode {
  ...
  public   RowTrackingUpdateCommonRowTrackingUpdateDVCDCOnColMapIdModeSuite ()  { throw new RuntimeException(); }
  ...
  protected  int numRowsPerFile ()  { throw new RuntimeException(); }
  protected  int numRowsTarget ()  { throw new RuntimeException(); }
  ...
  protected  java.lang.String targetTableName ()  { throw new RuntimeException(); }
