...
public abstract class DeltaInsertIntoTests extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.InsertIntoSQLOnlyTests {
  // not preceding
  public   DeltaInsertIntoTests (boolean supportsDynamicOverwrite, boolean includeSQLOnlyTests)  { throw new RuntimeException(); }
   ...
   * ("INSERT") or using the DataFrameWriter (<code>df.write.insertInto</code>). Insertions will be
