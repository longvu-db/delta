...
public  class UpdateBaseTempViewSQLPathBasedCDCOnRowTrackingOffSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.UpdateBaseTempViewTests, org.apache.spark.sql.delta.UpdateSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsPathBased, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.rowtracking.RowTrackingDisabled {
  ...
  public   UpdateBaseTempViewSQLPathBasedCDCOnRowTrackingOffSuite ()  { throw new RuntimeException(); }
