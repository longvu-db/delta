...
public  class ChecksumSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.DeltaTestUtilsBase, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.test.DeltaSQLTestUtils, org.apache.spark.sql.delta.coordinatedcommits.CatalogOwnedTestBaseSuite {
  public   ChecksumSuite ()  { throw new RuntimeException(); }
  ...
  public  void testIncrementalChecksumWrites (scala.Function1<java.lang.String, scala.runtime.BoxedUnit> tableMutationOperation)  { throw new RuntimeException(); }
