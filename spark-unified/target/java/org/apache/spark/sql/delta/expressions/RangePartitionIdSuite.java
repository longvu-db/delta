...
public  class RangePartitionIdSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.sql.catalyst.expressions.ExpressionEvalHelper, org.apache.spark.sql.test.SharedSparkSession {
  ...
  public   RangePartitionIdSuite ()  { throw new RuntimeException(); }
  ...
  public <T extends java.lang.Object> org.apache.spark.Partitioner getPartitioner (scala.collection.immutable.Seq<T> data, int partitions, scala.math.Ordering<T> evidence$1, scala.reflect.ClassTag<T> evidence$2)  { throw new RuntimeException(); }
  ...
  public <T extends java.lang.Object> void testRangePartitionerExpr (scala.collection.immutable.Seq<T> data, int partitions, org.apache.spark.sql.catalyst.expressions.Expression childExpr, Object expected, scala.math.Ordering<T> evidence$3, scala.reflect.ClassTag<T> evidence$4)  { throw new RuntimeException(); }
