...
/**
 * Tests that the <code>replaceUsing</code> and <code>replaceOn</code> options are blocked for DFv2
 * create/replace/createOrReplace operations.
 */
public  class DeltaInsertReplaceOnOrUsingDFv2CreateReplaceBlockingSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  public   DeltaInsertReplaceOnOrUsingDFv2CreateReplaceBlockingSuite ()  { throw new RuntimeException(); }
  ...
  protected  void createTable (java.lang.String tableName, scala.collection.immutable.Seq<java.lang.String> tableCols, scala.collection.immutable.Seq<java.lang.String> partCols, scala.collection.immutable.Seq<java.lang.String> clusterCols)  { throw new RuntimeException(); }
