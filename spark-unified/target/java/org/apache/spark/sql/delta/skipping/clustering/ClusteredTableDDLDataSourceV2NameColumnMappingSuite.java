...
public  class ClusteredTableDDLDataSourceV2NameColumnMappingSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.skipping.clustering.ClusteredTableDDLWithNameColumnMapping, org.apache.spark.sql.delta.skipping.clustering.ClusteredTableDDLWithV2, org.apache.spark.sql.delta.skipping.clustering.ClusteredTableDDLWithColumnMappingV2, org.apache.spark.sql.delta.skipping.clustering.ClusteredTableDDLSuite {
  public   ClusteredTableDDLDataSourceV2NameColumnMappingSuite ()  { throw new RuntimeException(); }
  ...
  protected  java.lang.String sourceTable ()  { throw new RuntimeException(); }
  ...
  protected  java.lang.String targetTable ()  { throw new RuntimeException(); }
