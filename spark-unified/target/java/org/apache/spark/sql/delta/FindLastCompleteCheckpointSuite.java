...
public  class FindLastCompleteCheckpointSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.coordinatedcommits.CoordinatedCommitsBaseSuite {
  public  org.apache.spark.sql.delta.DeltaTestUtilsBase.ExpectedResult$ ExpectedResult ()  { throw new RuntimeException(); }
  public   FindLastCompleteCheckpointSuite ()  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Map<java.lang.String, java.lang.String> getLastCompleteCheckpointUsageLog (scala.Function0<scala.runtime.BoxedUnit> f)  { throw new RuntimeException(); }
