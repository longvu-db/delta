...
public  class UpdateBaseMiscSQLPathBasedCDCOnRowTrackingOnSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.UpdateBaseMiscTests, org.apache.spark.sql.delta.UpdateSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsPathBased, org.apache.spark.sql.delta.cdc.CDCEnabled, org.apache.spark.sql.delta.rowtracking.RowTrackingEnabled, org.apache.spark.sql.delta.rowid.UpdateWithRowTrackingOverrides {
  ...
  public   UpdateBaseMiscSQLPathBasedCDCOnRowTrackingOnSuite ()  { throw new RuntimeException(); }
  ...
  public  java.lang.String fileFormat ()  { throw new RuntimeException(); }
