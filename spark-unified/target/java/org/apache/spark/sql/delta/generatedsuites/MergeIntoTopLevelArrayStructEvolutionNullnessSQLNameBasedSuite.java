...
public  class MergeIntoTopLevelArrayStructEvolutionNullnessSQLNameBasedSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.MergeIntoTopLevelArrayStructEvolutionNullnessTests, org.apache.spark.sql.delta.MergeIntoSQLMixin, org.apache.spark.sql.delta.DeltaDMLTestUtilsNameBased {
  public  org.apache.spark.sql.delta.MergeIntoStructEvolutionNullnessTestUtils.ActionType$ ActionType ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaTestUtilsBase.ExpectedResult$ ExpectedResult ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.MergeHelpers.MatchedClause$ MatchedClause ()  { throw new RuntimeException(); }
  public   MergeIntoTopLevelArrayStructEvolutionNullnessSQLNameBasedSuite ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.MergeHelpers.NotMatchedBySourceClause$ NotMatchedBySourceClause ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.MergeHelpers.NotMatchedClause$ NotMatchedClause ()  { throw new RuntimeException(); }
  public  org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig$ PatienceConfig ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.MergeIntoStructEvolutionNullnessTestUtils.SourceType$ SourceType ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.MergeIntoStructEvolutionNullnessTestUtils.StructEvolutionNullnessTestCase$ StructEvolutionNullnessTestCase ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.MergeIntoStructEvolutionNullnessTestUtils.TargetType$ TargetType ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Set<java.lang.String> expectedOpTypes ()  { throw new RuntimeException(); }
  protected  scala.collection.immutable.Set<java.lang.String> expectedOpTypesInsertOnly ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Map<java.lang.String, java.lang.String> mappedErrorClasses ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> preserveNullStructsConfs ()  { throw new RuntimeException(); }
