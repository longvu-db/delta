...
public  class DeltaVacuumSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.DeltaVacuumSuiteBase, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.AdvanceClock$ AdvanceClock ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.CheckFiles$ CheckFiles ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.CreateDirectory$ CreateDirectory ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.CreateFile$ CreateFile ()  { throw new RuntimeException(); }
  public   DeltaVacuumSuite ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.ExecuteVacuumInSQL$ ExecuteVacuumInSQL ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.ExecuteVacuumInScala$ ExecuteVacuumInScala ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.ExpectFailure$ ExpectFailure ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaTestUtilsBase.ExpectedResult$ ExpectedResult ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.GC$ GC ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.GCByInventory$ GCByInventory ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.delta.DeltaVacuumSuiteBase.LogicallyDeleteFile$ LogicallyDeleteFile ()  { throw new RuntimeException(); }
  ...
  public  void purgeDVs (java.lang.String tableName)  { throw new RuntimeException(); }
