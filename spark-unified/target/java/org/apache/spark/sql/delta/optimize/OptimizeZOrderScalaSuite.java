 ...
 */
public  class OptimizeZOrderScalaSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.optimize.OptimizeZOrderSuiteBase, org.apache.spark.sql.delta.test.DeltaSQLCommandTest {
  public  org.apache.spark.sql.delta.test.TestsStatistics.FileScanExecNode$ FileScanExecNode ()  { throw new RuntimeException(); }
  public   OptimizeZOrderScalaSuite ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> executeOptimizePath (java.lang.String path, scala.collection.immutable.Seq<java.lang.String> zOrderBy, scala.Option<java.lang.String> condition)  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> executeOptimizeTable (java.lang.String table, scala.collection.immutable.Seq<java.lang.String> zOrderBy, scala.Option<java.lang.String> condition)  { throw new RuntimeException(); }
  protected  scala.Function2<org.apache.spark.sql.delta.DeltaLog, scala.collection.immutable.Seq<org.apache.spark.sql.Column>, org.apache.spark.sql.Dataset<org.apache.spark.sql.Row>> getStatsDf ()  { throw new RuntimeException(); }
