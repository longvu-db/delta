...
public  class IdentityColumnConflictScalaSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.IdentityColumnConflictSuiteBase, org.apache.spark.sql.delta.ScalaDDLTestUtils {
  public  org.apache.spark.sql.delta.DDLTestUtils.DDLType$ DDLType ()  { throw new RuntimeException(); }
  public   IdentityColumnConflictScalaSuite ()  { throw new RuntimeException(); }
  ...
  protected  scala.collection.immutable.Seq<org.apache.spark.sql.delta.TransactionConflictTestCase> conflictTestCases ()  { throw new RuntimeException(); }
