...
public  class MergeIntoMaterializeSourceMergePersistentDVOffSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.delta.MergeIntoMaterializeSourceTests, org.apache.spark.sql.delta.MergePersistentDVDisabled {
  public  org.apache.spark.sql.delta.DeltaTestUtilsBase.ExpectedResult$ ExpectedResult ()  { throw new RuntimeException(); }
  public   MergeIntoMaterializeSourceMergePersistentDVOffSuite ()  { throw new RuntimeException(); }
