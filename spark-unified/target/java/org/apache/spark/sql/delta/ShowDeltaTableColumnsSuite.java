...
public  class ShowDeltaTableColumnsSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.test.SharedSparkSession, org.apache.spark.sql.delta.test.DeltaSQLCommandTest, org.apache.spark.sql.delta.DeltaTestUtilsForTempViews {
  ...
  public   ShowDeltaTableColumnsSuite ()  { throw new RuntimeException(); }
  ...
  protected  void checkResult (org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> result, scala.collection.immutable.Seq<scala.collection.immutable.Seq<java.lang.Object>> expected, scala.collection.immutable.Seq<java.lang.String> columns)  { throw new RuntimeException(); }
